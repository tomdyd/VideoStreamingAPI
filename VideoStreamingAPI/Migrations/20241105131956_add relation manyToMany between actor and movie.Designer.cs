...
namespace VideoStreamingAPI.Migrations
{
    ...
    [Migration("20241105131956_add relation manyToMany between actor and movie")]
    partial class addrelationmanyToManybetweenactorandmovie
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VideoStreamingAPI.Models.Movie", b =>
                {
                    ...
                    b.Property<string>("PlaylistFileName")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("SegmentsDirectory")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("VideoStreamingAPI.Models.RefreshToken", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VideoStreamingAPI.Models.Tag", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("VideoStreamingAPI.Models.AppUserModel", null)
                        .WithMany()
            ...
            modelBuilder.Entity("VideoStreamingAPI.Models.MovieTag", b =>
                {
                    ...
                    b.HasOne("VideoStreamingAPI.Models.Tag", "Tag")
                        .WithMany("MovieTags")
                        .HasForeignKey("TagId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
